      ...
      {filteredProducts.length === 0 ? (
        <div className="bg-[#211a24] border border-white/10 rounded-3xl p-12 text-center space-y-4 my-8 shadow-xl">
          ...
          <button
            ...
            className="inline-flex items-center justify-center px-4 py-2.5 text-xs font-semibold bg-[#65486f] text-white hover:bg-[#7a5985] rounded-xl transition-colors cursor-pointer"
          >
            Clear search and filters
          </button>
        </div>
      ) : (
        /* SECTIONED PRODUCT LISTINGS */

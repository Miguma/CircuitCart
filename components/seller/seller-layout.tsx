...
export function SellerLayout({
  ...
  isVerificationOnlyNav = false,
}: SellerLayoutProps) {
  const pathname = usePathname();
  const navLinks = isVerificationOnlyNav ? VERIFICATION_ONLY_LINKS : MANAGEMENT_LINKS;
